...
class TestGateSweep(unittest.TestCase):
    ...
    def test_analyseGateSweep(self):
        ...
        result = analyseGateSweep(data_set)
        self.assertAlmostEqual(result['_pinchvalueX'], -450.0)
        self.assertAlmostEqual(result['lowvalue'], 9.445888759986548e-18)
        self.assertAlmostEqual(result['highvalue'], 0.9999999999999998)
        self.assertAlmostEqual(result['midvalue'], 0.29999999999999993)
