...
class TestTunneling(TestCase):
    ...
    def test_polFitting(self):
        ...
        self.assertAlmostEqual(par_fit.min(), -0.502742506913356, 6)
        self.assertAlmostEqual(par_fit.max(), 303.2601434943597, 6)
        self.assertAlmostEqual(par_fit.sum(), 423.8971145696139, 3)
