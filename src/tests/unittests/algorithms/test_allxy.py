...
class TestAllxy(unittest.TestCase):
    ...
    def test_allxy_covariance_regression(self):
        allxy_data =[0.175, 0.24166666666666667, 0.23166666666666666, 0.2, 0.21, 0.49666666666666665, 0.5316666666666666, 0.545, 0.53, 0.605, 0.5466666666666666, 0.58, 0.505, 0.5916666666666667, 0.6, 0.53, 0.5716666666666667, 0.9016666666666666, 0.91, 0.905, 0.9033333333333333]        
