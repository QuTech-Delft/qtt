...
class TestPlotting(unittest.TestCase):
    ...
    def test_plot_dataset_1d(self, fig=None):
        dataset = qcodes.tests.legacy.data_mocks.DataSet1D()
        if fig is not None:
...
class TestData(unittest.TestCase):
    ...
    def test_transform(self):
        dataset = qcodes.tests.legacy.data_mocks.DataSet2D()
    ...
    def test_dataset1Dmetadata(self):
        dataset = qcodes.tests.legacy.data_mocks.DataSet1D(name='test1d')
    ...
    def test_dataset_to_dictionary(self):
        ...
        input_dataset = qcodes.tests.legacy.data_mocks.DataSet2D()
    ...
    def test_numpy_on_dataset(verbose=0):
        all_data = qcodes.tests.legacy.data_mocks.DataSet2D()
        x = all_data.z
        _ = np.array(x)
        s = np.linalg.svd(x)
        if verbose:
    ...
    @staticmethod
    def test_compare():
        ds = qcodes.tests.legacy.data_mocks.DataSet2D()
    ...
    def test_add_comment(self):
        ds0 = qcodes.tests.legacy.data_mocks.DataSet2D()
        ds = qcodes.tests.legacy.data_mocks.DataSet2D()
        try:
    ...
    def test_load_dataset(verbose=0):
        ...
        for jj, fmt in enumerate([g, h]):
            ds = qcodes.tests.legacy.data_mocks.DataSet2D(name='format%d' % jj)
            ds.formatter = fmt
            ds.io = disk_io
