...
class livePlot:
    ...
    def __init__(self,gates,sweepgates,sweepranges,verbose=1):
        ...
        if len(sweepgates) == 1:
            ...
            raise Exception('The number of sweepgates should be either 1 or 2.')
...
class fpgaCallback_hc:
    ...
    def __call__(self):
        ...
        im_diff = ndimage.gaussian_filter1d(Z, axis=self.diffaxis, sigma=self.diffsigma, order=order, mode='nearest')
